...
- (void)viewDidLoad {
    ...
    if (self.displayActionButton) {
        _actionButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAction target:self action:@selector(delete:)];
    }
...
//    MWPhoto * photo = [_delegate photoBrowser:self photoAtIndex:1];
//    
//    photo.caption = @"Mannequin";
   ...
   NSUInteger  num =  [self numberOfPhotos];
    ...
    [ipcikersheet showActionSheet];
    

    
}
/////////////////IPickerActionSheetDelegate///////
-(void)image:(UIImage *)image data:(NSData *)imagedata didFinishPickingMediaWithInfo:(NSDictionary *)info{
 
    
    MWPhoto *     photo = [MWPhoto photoWithImage:image];
    photo.data = imagedata;
    [_delegate addPicPhoto:photo];
...
-(void)delete:(id)sender{
    ...
    [_delegate delPicPhoto:_currentPageIndex];
