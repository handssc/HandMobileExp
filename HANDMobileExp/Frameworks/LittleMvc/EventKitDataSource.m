...
- (void)loadItemsFromDate:(NSDate *)fromDate toDate:(NSDate *)toDate
{
  // synchronous callback on the main thread
    ...
    self.cell.dateFrom.text = [self.cell.dateFormatter stringFromDate:fromDate];
    self.cell.dateTo.text = [self.cell.dateFormatter stringFromDate:toDate];
    self.cell.dateFromValue =fromDate;
    self.cell.dateToValue =toDate;
